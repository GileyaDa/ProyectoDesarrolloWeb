            ...
            <section class="contenedor sobre-nosotros">
                <div class="contenedor-sobre-nosotros">
                    ...
                    <div class="contenido-textos">
                        ...
                        <p>Bienvenido a Coffee Tech, donde fusionamos la pasión por el café y la tecnología para ofrecerte una experiencia única. 
                            Contamos con instalaciones equipadas con tecnología innovadora, brindando un servicio al cliente de alta calidad mediante 
                            experiencias con realidad virtual. Explora nuestra diversidad de productos de alta calidad y descubre el placer de la fusión 
                            entre el café y la innovación.</p>
                    </div>
                </div>
                <div class="contenedor-sobre-nosotros">
                    <div class="contenido-textos">
                        <h3><span>✓</span>Nuestra historia</h3>
                        <p>En Coffee Tech, nuestra historia se construye sobre la base de la innovación y el deseo de ofrecer experiencias únicas. 
                            Aunque somos nuevos en el sector empresarial, nuestra visión es trascender las expectativas al combinar la pasión por el
                            café con las últimas tendencias tecnológicas. Descubre cómo comenzamos nuestro viaje en la intersección del café y la 
                            tecnología en 2023</p>
                    </div>
                ...
                <div class="cards">
                    <div class="card">
                        ...
                        <div class="contenido-texto-card">
                            <h4>Equipo</h4>
                            <p>El equipo detrás de Grupo Campo Verde ... Juntos, compartimos la visión de . Cada uno de nosotros, incluyéndote, desempeñamos un papel clave, aportando nuestras habilidades y pasiones.</p>
                        </div>
                    </div>
                </div>
            </section>
